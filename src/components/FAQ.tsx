...
export const FAQ = ({ id }: { id: string }) => {
  ...
  const faqs = [
    ...
    {
      question: "Can you help me deploy and launch my app?",
      answer: "Of course! I handle deployment on platforms like Vercel, Railway, or custom servers — including domains, SSL, CI/CD, and more."
    },
    {
      question: "How do you ensure security in a SaaS app?",
